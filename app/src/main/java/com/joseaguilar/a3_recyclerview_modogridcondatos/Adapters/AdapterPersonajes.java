package com.joseaguilar.a3_recyclerview_modogridcondatos.Adapters;
...
import com.joseaguilar.a3_recyclerview_modogridcondatos.R;
...
public class AdapterPersonajes extends RecyclerView.Adapter<AdapterPersonajes.ViewHolderPersonajes> {
    ...
    public AdapterPersonajes.ViewHolderPersonajes onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.molde_grid_personajes, null, false);
